/**
 * FREE CALL — the numbered passing system, thinned to three examples.
 *
 * Sources:
...
function routeOn(num: number, from: Pt, side: 1 | -1, widen = 1): Action[] {
  ...
  if (!def) throw new Error(`free-call: no route numbered ${num}`)
  return [
    {
      kind: 'route',
...
/** Everything that is the same on every dropback free call out of Red. */
const DROPBACK_JOBS = {
  Y: a(
  ...
  LT: a(
    'Ram — slide right. Block the man in your right gap.',
    'Short kick with your right foot, hands inside, and defend the gap between you and the guard. The man over the guard is the one who attacks it. Ram means the whole line moves right together — you are the back end of that.',
  ),
  LG: a(
    'Ram — slide right. Block the man in your right gap.',
  ...
  C: a(
    'Snap, then slide right. Block the man in your right gap.',
    'Snap it and get your right hand and right foot moving the same instant. Your gap is between you and the right guard. Never turn your shoulders — square, and let him come to you.',
  ),
  RG: a(
    'Ram — slide right. Block the man in your right gap.',
    'The man over you can slant either way; step right, get your hands on his near number and wall him. Do not chase a man who goes away from you — the guy behind you has him.',
  ),
  RT: a(
    'Ram — slide right. You have the end outside you.',
  ...
  S: a(
    ...
    'Ram slides right, so you set at the LEFT tackle\'s inside hip and you have the first man through there. Chest square, eyes inside-out. If nobody comes, stay home — you are the last thing between a blitzer and the quarterback.',
  ),
  Q: a(
...
/** Everything that is the same on every sprint free call out of Red. */
const SPRINT_JOBS = {
  Y: a(
    'Zero — block. You have the end on your side.',
  ...
  LT: a(
    'Sprint Rt — REACH right. Block the man in your right gap.',
    'Reach means get your head and your playside hand across him, not just push. Rip your right arm through and run your feet — the pocket is moving to the right and you have to move with it.',
  ),
  LG: a(
    'Sprint Rt — REACH right. Block the man in your right gap.',
  ...
  C: a(
    'Snap, then REACH right. Block the man in your right gap.',
    'Snap and reach in one motion — that is the hardest block on the play. Get your right hand on his playside number and turn him. If you get beat, get beat from behind, never from the front side.',
  ),
  RG: a(
    'Sprint Rt — REACH right. Block the man in your right gap.',
  ...
  RT: a(
    'Sprint Rt — REACH the man outside you.',
  ...
  S: a(
    ...
    'Straight out of the backfield to the call side, flat and fast. Find the outermost rusher on that side and kick him out. You are the edge of the pocket and the quarterback is running right at your outside shoulder — do not let anything under you.',
  ),
  Q: a(
    'Sprint right. Gain depth, then sprint downhill toward the sideline.',
...
const OVERRIDES_43: Partial<Record<OffPosId, Assignment>> = {
  LG: a(
    ...
    'This front only has four down linemen and none of them is in the gap between you and the center. Do not go looking for work — set right, keep your eyes on the Mike, and blow up anybody who blitzes that gap.',
  ),
  C: a(
    'You have the Mike.',
    'He is stacked right over the ball, and in this front he is the only backer who can get to the quarterback inside. Snap, slide right, and put your hat on him the moment he moves.',
  ),
}
...
const OVERRIDES_52: Partial<Record<OffPosId, Assignment>> = {
  ...
  C: a(
    ...
    'A man on your nose is what makes this an ODD front. Snap and get into him right now — you cannot let a nose guard walk you back into the quarterback\'s lap.',
  ),
  RG: a(
    'Odd front — uncovered. Climb to the backer on your side.',
...
const S_52_DROPBACK_ASSIGNMENT: Assignment = a(
  ...
  'Against a 5-2 every inside gap already has a blocker, so there is no hip for you to sit on. Come out of the backfield to the right and kick the end out. If you stay inside on this front, nobody blocks him.',
)
...
const assignments33: Record<OffPosId, Assignment> = {
  ...DROPBACK_JOBS,
  X: a(
    'First digit: 3 — hitch.',
...
export const freeCall33Red: Play = {
  id: 'free-call-33-red',
  name: 'Free Call 33',
  callName: 'Red Ram 33',
  family: 'pass',
  ...
  assignments: assignments33,
  vs: dropbackPlans(skill33),
  reviewNotes: [
...
export const freeCall33Black: Play = mirrorPlay(freeCall33Red, {
  id: 'free-call-33-black',
  callName: 'Black Bull 33',
  formation: 'black',
  description:
...
const skill12: Skill = {
  X: routeOn(1, AT_X, 1),
  // The wing's speed out has to run past the split end's alignment to get to
  // the sideline — see the wing-route-width note.
  R: routeOn(2, AT_R, 1, 1.6),
}

const assignments12: Record<OffPosId, Assignment> = {
  ...DROPBACK_JOBS,
  X: a(
    'First digit: 1 — slant.',
...
export const freeCall12Red: Play = {
  id: 'free-call-12-red',
  name: 'Free Call 12',
  callName: 'Red Ram 12',
  family: 'pass',
...
export const freeCall12Black: Play = mirrorPlay(freeCall12Red, {
  id: 'free-call-12-black',
  callName: 'Black Bull 12',
  formation: 'black',
  description:
...
const skill54: Skill = {
  X: routeOn(5, AT_X, 1),
  // p18 draws the wheel turning up OUTSIDE the curl; the wing starts eight
  // yards inside it, so the flat part of the route is stretched to get there.
  R: routeOn(4, AT_R, 1, 1.7),
}

const assignments54: Record<OffPosId, Assignment> = {
  ...SPRINT_JOBS,
  X: a(
    'First digit: 5 — curl.',
  ...
  Q: a(
    'Sprint right. Curl first, then the wheel over the top.',
    'Gain depth for three steps, then downhill at the sideline. Outside digit first: the curl is your rhythm throw. If the corner jumps it, the wheel is running right behind him and you throw it over the top. If neither is there, get to the sideline and run.',
  ),
}

export const freeCall54Red: Play = {
  id: 'free-call-54-red',
  name: 'Free Call 54',
  callName: 'Red Sprint Rt 54',
  family: 'pass',
  formation: 'red',
  direction: 'right',
  ballCarrier: 'Q',
  ...
  assignments: assignments54,
  vs: sprintPlans(skill54),
  reviewNotes: [
...
export const freeCall54Black: Play = mirrorPlay(freeCall54Red, {
  id: 'free-call-54-black',
  callName: 'Black Sprint Lt 54',
  formation: 'black',
  description:
...
export const freeCallPlays: Play[] = [
  freeCall33Red,
  freeCall33Black,
  freeCall12Red,
  freeCall12Black,
