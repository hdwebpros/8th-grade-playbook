...
// on "one-two-three" — thrown, thrown away, or he is running with it.
...
export const splitWideVictory: Play = {
  ...
  coachNotes: [
    'Quarterback: guess the blitz side and tell Super. Fake, set, throw. One-two-three and the ball is GONE.',
